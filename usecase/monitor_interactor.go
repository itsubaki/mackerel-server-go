...
func (intr *MonitorInteractor) Save(orgID string, monitor *domain.Monitoring) (interface{}, error) {
...
func (intr *MonitorInteractor) Update(orgID string, monitor *domain.Monitoring) (interface{}, error) {
	return intr.MonitorRepository.Update(orgID, monitor)
}

func (intr *MonitorInteractor) Monitor(orgID, monitorID string) (interface{}, error) {
	return intr.MonitorRepository.Monitor(orgID, monitorID)
}

func (intr *MonitorInteractor) Delete(orgID, monitorID string) (interface{}, error) {
